...
Group: Applications/Editors
Requires: vim-common = %{epoch}:%{version}-%{release} libattr >= 2.4 gtk2
...
%configure --with-features=huge \
  ...
  --with-compiledby="Brenton Horne <brentonhorne77@gmail.com>" --enable-cscope \
  --with-modified-by="Brenton Horne <brentonhorne77@gmail.com>" \
%if "%{withnetbeans}" == "1"
  --enable-netbeans \
%else
  --disable-netbeans \
...
%changelog
* Wed Dec 28 2016 Brenton Horne <brentonhorne77@gmail.com> - 2:8.0.0134-1
- First release as maintainer in Copr/OBS
